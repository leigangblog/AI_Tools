...
from chinese_ocr import Ui_MainWindow
import main_func
from img_gen_webfunc import get_chinese_ocr_db_crnn_server
...
class QmyMainWindow1(QMainWindow):
    ...
    def deal_img(self):
        if len(str(self.filename1)) > 0:
            ...
            # print(img_path)
            res,output_path=get_chinese_ocr_db_crnn_server(img_path=img_path)
