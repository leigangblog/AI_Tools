...
from yolov3_resnet50 import Ui_MainWindow
import main_func
from img_gen_webfunc import get_yolov3_resnet50_vd_coco2017
...
class QmyMainWindow1(QMainWindow):
    ...
    def deal_img(self):
        if len(str(self.filename1)) > 0:
            ...
            # print(img_path)
            res,output_path=get_yolov3_resnet50_vd_coco2017(img_path=img_path)
            if(len(str(output_path)))>0:
                dlgTitle = "温馨提示"
                strInfo = "运行结果请查看:"+output_path
